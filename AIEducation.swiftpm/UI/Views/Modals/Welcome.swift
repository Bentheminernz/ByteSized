...
struct WelcomePage2: View {
  var body: some View {
    VStack {
      ...
      Text("Some of the contents in this app are generated using AI technologies. The outputs of these technologies may not always be accurate. Content generated by AI will be clearly marked with the highlight shown below")
        .padding(.bottom)
