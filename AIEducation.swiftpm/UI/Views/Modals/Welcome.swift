...
struct WelcomePage2: View {
  var body: some View {
    VStack {
      ...
      Text("Some of the contents in this app are generated using AI technologies. The outputs of these technologies may not always be accurate. Content generated by AI will be clearly marked with the highlight shown below. Where possible prompts used to generate the content will also be provided.")
        .padding(.bottom)
      ...
      HStack(spacing: 40) {
        VStack {
          ...
          if let url = Bundle.main.url(forResource: "E7533C1F-2A1E-4270-9023-E74C0C4D18D8", withExtension: "jpeg") {
...
struct WelcomeComponents {
  @ViewBuilder
  static func WelcomePoint(title: String, description: String, imageName: String) -> some View {
    HStack {
  ...
  @ViewBuilder
  static func WelcomePageHeader(title: String, subtitle: String, imageName: String, imageColor: Color = .accentColor) -> some View {
    VStack(spacing: 16) {
      Image(systemName: imageName)
        .font(.system(size: 72))
